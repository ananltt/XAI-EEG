...
if __name__ == "__main__":
    ...
    # # USE OF EEGNET WITH SC - TODO: sistemare
    #
    ...
    # print("\nTest loss, Test accuracy: ", results)
    #
    # ablation(test_sc, test_labels, model, results[1], extract_statistical_characteristics, n_segments)
    ...
    # print("\nTest loss, Test accuracy: ", results)
    # 
    # ablation(test_fft, test_labels, model, results[1], extract_wt, n_segments)
